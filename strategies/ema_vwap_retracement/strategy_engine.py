...
# Corrected Import
from common.market_data import fetch_upstox_intraday_candles, get_nfo_lot_size, get_instrument_df, get_upstox_key, get_option_legs
...
def process_ema_vwap_strategy(symbols, start_date, end_date, upstox_token, progress_callback=None, log_func=print):
    ...
    for sym_idx, symbol in enumerate(symbols):
        ...
        for idx, trade in enumerate(entries):
            ...
            # Calling the unified option leg finder
